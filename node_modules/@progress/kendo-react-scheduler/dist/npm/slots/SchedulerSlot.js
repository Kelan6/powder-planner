...
exports.SchedulerSlot = React.forwardRef(function (props, ref) {
    ...
    var _a = (0, useSchedulerSlot_1.useSchedulerSlot)(props, ref), slot = _a.slot, element = _a.element;
    ...
    var tabIndex = props.tabIndex !== undefined
        ...
        : props.selected
            ? 0
            : -1;
    var className = React.useMemo(function () { return (0, kendo_react_common_1.classNames)(props.className, 'k-scheduler-cell k-slot-cell', {
    ...
    var slotLabel = React.useMemo(function () { return "".concat((0, utils_1.formatEventTime)(intl, props.zonedStart, props.zonedEnd, props.isAllDay || false)); }, [intl, props.isAllDay, props.zonedEnd, props.zonedStart]);
    // Handlers
    // Focus Handlers
