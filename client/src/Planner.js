...
function Planner({ currentUser, setCurrentUser }) {
  ...
  return (
    ...
    <div class="overflow-x-auto relative flex flex-col items-center">
      ...
      {/* <button class='text-white' > Create Meet Up + </button> */}
      <button onClick={handleAddClick} type="button" class="py-2.5 px-5 mr-2 text-sm font-medium text-white-600 bg-white rounded-xl border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 inline-flex items-center">
